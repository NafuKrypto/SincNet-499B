...
model_file= 'sincnetmodel/sincnet_timit/model_raw.pkl' # This is the model to use for computing the d-vectors (it should be pre-trained using the speaker-id DNN)
cfg_file=r'cfg/SincNet_TIMIT.cfg' # Config file of the speaker-id experiment used to generate the model
te_lst=r'data_lists/libri_te.scp' # List of the wav files to process
out_dict_file=r'd_vect_timit.npy' # output dictionary containing the a sentence id as key as the d-vector as value
data_folder=r'timitnlibri/'
