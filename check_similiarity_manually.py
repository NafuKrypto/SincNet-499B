# -*- coding: utf-8 -*-
"""
Created on Tue Jan  4 16:48:48 2022
...
for index in range (0,2):
    ...
    model_file= 'test_deploy/libri_600/model_raw.pkl' # This is the model to use for computing the d-vectors (it should be pre-trained using the speaker-id DNN)
    cfg_file=r'cfg/SincNet_Librispeech.cfg' # Config file of the speaker-id experiment used to generate the model
...
print("\n")
if result_cos_sim>=0.95:
    print(speakers[0],"and",speakers[1], "are the same")
elif result_cos_sim<0.95:
